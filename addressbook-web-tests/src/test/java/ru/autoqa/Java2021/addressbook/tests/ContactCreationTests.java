...
public class ContactCreationTests extends TestBase {
    ...
    public void testCreationNewContact() throws Exception {
        ...
        app.getContactHelper().fillBaseInformation(new ContactData("Mike", "Green", "nicc", "Jn", "Petrozavodsk", "335999", "8923294455","dfdfn@gmail.com", "ssstr.ru", "6", "February", "1990", "-", "hi!"));
